    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20">
        ...
        >
          ...
          >
            <ShieldCheck size={26} style={{ color: '#6ABDB2' }} strokeWidth={1.5} />
          </div>
        ...
        >
          ...
          >
            ...
            {/* 1 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">1. البيانات التي نجمعها</h2>

            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">1.1 بيانات المؤسسة (عند إنشاء الحساب)</h3>
            ...
            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">1.2 بيانات الاستخدام التقني</h3>
            <ul className="list-disc list-inside space-y-2 text-slate-300 pr-4 mb-4">
            ...
            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">1.3 البيانات التشغيلية للمؤسسة</h3>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 2 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">2. تخزين البيانات وأمانها</h2>

            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">2.1 البنية التحتية</h3>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">2.2 تشفير كلمات المرور</h3>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            <h3 className="text-base font-bold text-emerald-300 mt-5 mb-2">2.3 البيانات المحذوفة</h3>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 3 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">3. بيانات الدفع</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 4 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">4. ملفات الارتباط (Cookies)</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 5 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">5. مسؤولية المؤسسة عن بيانات طلابها</h2>
            ...
            {/* 6 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">6. الإفصاح عن البيانات لأطراف ثالثة</h2>
            <p className="mb-3 leading-relaxed text-slate-300">
            ...
            {/* 7 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">7. حالات انقطاع الخدمة</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 8 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">8. التواصل معنا</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
            ...
            {/* 9 */}
            <h2 className="text-xl font-bold text-emerald-400 mt-8 mb-4">9. التعديل على سياسة الخصوصية</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
